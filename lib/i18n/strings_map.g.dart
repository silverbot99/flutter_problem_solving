...
extension on _StringsVi {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'strings.navigation.bottom.home': return 'Trang chủ';
			...
			case 'strings.dashboard.greeting': return 'Chào buổi sáng, Silvia';
			case 'strings.dashboard.how_you_feel': return 'Bây giờ bạn cảm thấy thế nào?';
			case 'strings.dashboard.description': return 'Mô tả vấn đề bạn đang gặp?';
			case 'strings.dashboard.info_problem': return 'Tình hình, sự kiện hiện tại, có những thông tin gì?';
			case 'strings.dashboard.hint_write': return 'Viết gì đó...';
			default: return null;
		}
	}
}
