...
class CustomTextFieldSignUp extends StatefulWidget {
  ...
  @override
  State<CustomTextFieldSignUp> createState() => _CustomTextFieldSignUpState();
}

class _CustomTextFieldSignUpState extends State<CustomTextFieldSignUp> {
                ...
                children: [
                  ReactiveTextField(
                    ...
                    validationMessages: {
                      ...
                      ValidationMessage.required: (_) => context.t.strings.errors.form.required(field: widget.labelText),
